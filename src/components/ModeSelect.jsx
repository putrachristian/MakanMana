    ...
    <div className="h-full flex flex-col items-center justify-center p-8 bg-gradient-to-b from-[#FFF7ED] to-white">
      ...
      <div className="w-full space-y-6">
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-br from-[#FFA654] to-[#FF8C42] p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all text-left relative overflow-hidden"
        >
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-br from-[#FF7F89] to-[#FFB6C1] p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all text-left relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 text-white/10 transform translate-x-4 -translate-y-4">
